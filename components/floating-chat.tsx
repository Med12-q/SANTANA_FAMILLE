      ...
      <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
        ...
        <AnimatePresence mode="wait">
          {open
            ...
            : <motion.div key="chat" initial={{rotate:90,opacity:0}} animate={{rotate:0,opacity:1}} exit={{rotate:-90,opacity:0}} transition={{duration:0.15}}><MessageSquare className="h-5 w-5" /></motion.div>
          }
        </AnimatePresence>
      </motion.button>
